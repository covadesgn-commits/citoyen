  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return profileAsync.when(
      data: (profile) {
        ...
        final mairieName = (profile?['mairie_name'] ?? 'Mairie').toString();
        final address = (profile?['address'] ?? 'Adresse non renseignée').toString();
        final initial = name.isNotEmpty ? name[0].toUpperCase() : 'M';

        return Scaffold(
          backgroundColor: AppColors.getBackgroundColor(context),
          appBar: AppBar(
            title: const Text('Profil mairie', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20)),
            backgroundColor: AppColors.getBackgroundColor(context),
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      const SizedBox(height: 32),
                      _buildProfileDetailRow(context, Icons.account_balance_rounded, mairieName, label: "Entité"),

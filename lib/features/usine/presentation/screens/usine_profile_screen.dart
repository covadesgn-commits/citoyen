...
class UsineProfileScreen extends ConsumerWidget {
  const UsineProfileScreen({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return profileAsync.when(
      data: (profile) {
        final String name = profile['name'] ?? 'Usine';
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      const SizedBox(height: 18),
                      _buildProfileDetailRow(context, Icons.location_on_outlined, address, label: "Siège"),
                    ],
                  ),
                ),
                ...
                statsAsync.when(
                  ...
                  error: (err, stack) => const Text('Erreur stats'),
                ),
